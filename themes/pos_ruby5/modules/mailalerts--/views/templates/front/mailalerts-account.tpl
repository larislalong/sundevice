	...
	{if $mailAlerts}
		<ul class="products-block">
			...
			<li class="clearfix{if $smarty.foreach.myLoop.last} last_item{/if}">
				<a class="products-block-image" href="{$link->getProductLink($mailAlert.id_product, null, null, null, null, $mailAlert.id_shop)}" title="{$mailAlert.name|escape:'html':'UTF-8'}"><img src="{$link->getImageLink($mailAlert.link_rewrite, $mailAlert.cover, 'home')|escape:'html'}" alt=""/></a>
