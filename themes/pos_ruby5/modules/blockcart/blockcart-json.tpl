...
"show_wrapping": {$show_wrapping|json_encode},
...
"currentDate" : {strtotime($currentDate)|json_encode},
"lastUpdateDate" : {strtotime($lastUpdateDate)|json_encode},
"isolatedQuantities" : {$isolatedQuantities|json_encode},
