...
<div class="block-newsletter">
	<div class="container">
		...
		<h2>{l s='Inscrivez-vous à notre Newsletter hebdomadaire' mod='blocknewsletter'}</h2>
		<p>{l s='Entrez votre adresse email dans le champs ci-après' mod='blocknewsletter'}<br/>{l s='et recevez nos annonces et informations privilégiées !' mod='blocknewsletter'}</p>
