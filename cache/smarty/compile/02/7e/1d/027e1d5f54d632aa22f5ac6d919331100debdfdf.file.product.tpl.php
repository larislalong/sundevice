<?php /* Smarty version Smarty-3.1.19, created on 2019-05-07 21:59:05
         compiled from "/home/sundevice/preprod/themes/pos_ruby5/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21029381685cd1e3899b39d5-93785526%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '027e1d5f54d632aa22f5ac6d919331100debdfdf' => 
    array (
      0 => '/home/sundevice/preprod/themes/pos_ruby5/product.tpl',
      1 => 1557140374,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21029381685cd1e3899b39d5-93785526',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd1e389c34ee9_35170253',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd1e389c34ee9_35170253')) {function content_5cd1e389c34ee9_35170253($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/sundevice/preprod/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/home/sundevice/preprod/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/sundevice/preprod/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/sundevice/preprod/tools/smarty/plugins/modifier.date_format.php';
...
<?php }?></span>
				...
				<?php if ((isset($_smarty_tpl->tpl_vars['inAdminGroup']->value)&&$_smarty_tpl->tpl_vars['inAdminGroup']->value)) {?>
					<p id="product_idp">
						<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'IDP:'),$_smarty_tpl);?>
 </label>
						...
						<tr>
							<td style="padding: 0 5px 0 0;">
								...
								<p id="product_lppe" style="margin:0;line-height:1;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'LPPE:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
								...
								<?php }?>
								<?php if ((isset($_smarty_tpl->tpl_vars['id_shop']->value)&&$_smarty_tpl->tpl_vars['id_shop']->value==2)) {?>
								<p id="product_lppu">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'LPPU:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
								<?php }?>
							</td>
							<td style="padding: 0 5px 0 0;<?php if ((isset($_smarty_tpl->tpl_vars['id_shop']->value)&&$_smarty_tpl->tpl_vars['id_shop']->value==1)) {?>vertical-align:top;<?php }?>">
						...
						<tr>
							...
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_11" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'11%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
						...
						<tr>
							...
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_13" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'13%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
						...
						<tr>
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_14" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'14%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
						...
						<tr>
							...
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_18" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'18%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
						...
						<tr>
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_19" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'19%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
						...
						<tr>
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_21" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'21%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
							<td style="padding: 0 5px 0 0;">
								<p id="product_floor_price_22" style="margin:0;">
									<label class="fontcustom1"><?php echo smartyTranslate(array('s'=>'22%:'),$_smarty_tpl);?>
 </label>
									<span class="editable"></span>
								</p>
							</td>
