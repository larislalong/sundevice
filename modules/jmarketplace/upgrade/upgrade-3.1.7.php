...
function upgrade_module_3_1_7($module)
{
    ...
    $metas = array(
        array(
            'page' => 'module-jmarketplace-dashboard',
            'configurable' => 1,
            'title' => 'JA Marketplace - Dashboard',
            'description' => 'This is page to sellers can see your dashboard.',
            'url_rewrite' => 'dashboard',
        ),
    );
    ...
    if (Module::isEnabled('jdashboard')) {
        Module::disableByName('jdashboard');
    }
