...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="included_accessories" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="included_accessories_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='Included accessories'}
			</span>
		</label>
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='included_accessories'
				class="autoload_rte"
				input_value=$product->included_accessories}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="tech_specs" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="tech_specs_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='Tech specs'}
			</span>
		...
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='tech_specs'
				class="autoload_rte"
				input_value=$product->tech_specs}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="what_is_model_number" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="what_is_model_number_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='Supported LTE Networks header'}
			</span>
		</label>
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='what_is_model_number'
				class="autoload_rte"
				input_value=$product->what_is_model_number}
		</div>
	</div>
	
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="what_is_a_grade" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="what_is_a_grade_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='What is a grade'}
			</span>
		...
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='what_is_a_grade'
				class="autoload_rte"
				input_value=$product->what_is_a_grade}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="available_packeging" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="available_packeging_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='Available packeging'}
			</span>
		</label>
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='available_packeging'
				class="autoload_rte"
				input_value=$product->available_packeging}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="tested_phone" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="tested_phone_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s=''}">
				{l s='Tested phone'}
			</span>
		...
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='tested_phone'
				class="autoload_rte"
				input_value=$product->tested_phone}
		</div>
	</div>
...
{include file="{$supportedltenetworks_js_tpl}"}
