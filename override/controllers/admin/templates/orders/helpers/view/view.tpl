						...
						<table class="table" id="orderProducts">
							<thead>
								<tr>
									...
									<th><span class="title_box ">{l s='Imei'}</span></th>
									{if ($order->getTaxCalculationMethod() != $smarty.const.PS_TAX_EXC)}
									<th>
										<span class="title_box ">{l s='Prix vendu'}</span>
									...
									<th>
										<span class="title_box ">{l s='Prix de base'}</span>
							...
							{foreach from=$products item=product key=k}
								...
								<tr class="product-line-row">
									...
									<td class="text-center">{$product['emei']}</td>
									{if ($order->getTaxCalculationMethod() != $smarty.const.PS_TAX_EXC)}
									...
									<td class="text-center">{displayPrice price=$product.product_old_price currency=$currency->id}</td>
