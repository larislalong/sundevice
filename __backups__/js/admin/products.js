		...
		function editProductAttribute (url, parent){
			$.ajax({
				...
				success: function(data) {
					...
					var deactivate_price_update = data[0]['deactivate_price_update'];

					if (typeof deactivate_price_update != 'undefined' && deactivate_price_update == 1)
					{
						$("#deactivate_price_update_on").attr('checked',true);
						$("#deactivate_price_update_off").attr('checked',false);
					}
					else
					{
						$("#deactivate_price_update_off").attr('checked',true);
						$("#deactivate_price_update_on").attr('checked',false);
					}
