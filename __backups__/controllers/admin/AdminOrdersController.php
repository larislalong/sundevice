                    ...
                    foreach (Tools::getValue('orderBox') as $id_order) {
                        ...
                        if (!Validate::isLoadedObject($order)) {
                            ...
                            if ($current_order_state->id == $order_state->id) {
                                ...
                                if ($history->id_order_state == 4 && $order->shipping_number) {
                                    // $templateVars = array('{followup}' => str_replace('@', $order->shipping_number, $carrier->url));
                                    $templateVars = array('{followup}' => 'http://www.dhl.fr/publish/fr/fr/eshipping/track.high.html?pageToInclude=RESULTS&type=trackindex&brand=I&AWB='.$order->shipping_number);
                                }
