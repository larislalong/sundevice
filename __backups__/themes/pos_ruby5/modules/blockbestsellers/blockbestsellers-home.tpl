...
<h4 class="block-title">{l s='Meilleures Ventes'}</h4>
{if isset($best_sellers) && $best_sellers}
	{include file="$tpl_dir./product-list.tpl" products=$best_sellers class='blockbestsellers tab-pane' id='blockbestsellers' has_big_item=true}
{else}
