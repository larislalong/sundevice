			...
			<div class="col-lg-12">
				<div class="checkbox alert alert-warning text-center">
					<label class="control-label" for="deactivate_price_update" >
						{l s='Désactiver la mise à jour automatique du prix de cette déclinaison ?'}
					</label>
					<label class="control-label" for="deactivate_price_update_on" >
						<input type="radio" name="deactivate_price_update" id="deactivate_price_update_on" {if $product->deactivate_price_update}checked="checked"{/if} value="1" />
						{l s='OUI'}
					</label>
					<label class="control-label" for="deactivate_price_update_off" >
						<input type="radio" name="deactivate_price_update" id="deactivate_price_update_off" {if !$product->deactivate_price_update}checked="checked"{/if} value="0" />
						{l s='NON'}
					</label>
					{*$product|var_dump*}
				</div>
...
<script type="text/javascript">
	var DISABLED_TEXT = '{l s='Disabled'}';
	var ENABLED_TEXT = '{l s='Enabled'}';
