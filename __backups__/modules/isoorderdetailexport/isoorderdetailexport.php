...
class Isoorderdetailexport extends Module
{
    ...
    public function getContent()
    {
        ...
        if (((bool)Tools::isSubmit('exportAndMail')) == true) {
            $this->postExportOrders('exportAndMail');
        }
        if (((bool)Tools::isSubmit('exportAndDownload')) == true) {
	...
	public function exportAndMail(array $odersDetails,$applied_filter){
		...
		if($email_cible and isset($odersDetails) and !empty($odersDetails)){
			...
			foreach($headers as $key => &$header){
				$integerArray = array('id_order','product_quantity','id_customer','quantity_in_stock');
				$priceArray = array('product_price','discount_price','base_price','reduced_price','price');
	...
	public function exportAndDownload(array $odersDetails){
