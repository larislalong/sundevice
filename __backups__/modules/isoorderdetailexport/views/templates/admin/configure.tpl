...
<div class="panel">
	<h3><i class="icon icon-folder-open"></i> {l s='Exportation instantannée - Filtres' mod='isoorderdetailexport'}</h3>
	...
	<form id="product-associations" class="panel product-tab" method="post">
		...
		<div class="panel-footer">
			<button type="submit" name="exportAndDownload" class="btn btn-default pull-right"><i class="process-icon-download"></i> {l s='Export et Téléchargement'}</button>
			<button type="submit" name="exportAndMail" class="btn btn-default pull-right"><i class="process-icon-envelope"></i> {l s='Export et Email'}</button>
		</div>
	</form>
