{if isset($moreinfos)}
<div class="moreinfos moreinfos-list">
    <ul>
        ...
        <li><span class="label">{l s='App' mod='importbtobdata'}</span>: <span class="value-item">{$moreinfos.app}</span></li>
        ...
        <li><span class="label">{l s='Last 7 days of inventory' mod='importbtobdata'}</span>: <span class="value-item">{$moreinfos.last_seven_day_inventory|intval}</span></li>
        <li><span class="label">{l s='Average basket' mod='importbtobdata'}</span>: <span class="value-item">{$moreinfos.average_basket}</span></li>
		...
		<li><span class="label">{l s='In Batch USA' mod='importbtobdata'}</span>: <span class="value-item">{$moreinfos.inbatch_usa}</span></li>
    </ul>
</div>
{/if}