<?php /* Smarty version Smarty-3.1.19, created on 2019-02-22 14:54:36
         compiled from "D:\wamp\www\projects\ps\sun-device.local\themes\pos_ruby5\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:221035c6fff1c15c0c6-34946885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2cb19f2688618298cc3729cb278b7cd71f9b0496' => 
    array (
      0 => 'D:\\wamp\\www\\projects\\ps\\sun-device.local\\themes\\pos_ruby5\\header.tpl',
      1 => 1550840185,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '221035c6fff1c15c0c6-34946885',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c6fff1c7f4673_48179037',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c6fff1c7f4673_48179037')) {function content_5c6fff1c7f4673_48179037($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include 'D:\\wamp\\www\\projects\\ps\\sun-device.local\\tools\\smarty\\plugins\\function.implode.php';
?>
<!DOCTYPE HTML>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if (isset($_smarty_tpl->tpl_vars['featuredCatObts']->value)&&count($_smarty_tpl->tpl_vars['featuredCatObts']->value)) {?>
				<div class="container clearfix">
					<div id="home_categories" class="center_column clearfix">
						<div id="home_categories_list">
							<ul class="clearfix">
							<?php  $_smarty_tpl->tpl_vars['cat'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['cat']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['featuredCatObts']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cat']->key => $_smarty_tpl->tpl_vars['cat']->value) {
$_smarty_tpl->tpl_vars['cat']->_loop = true;
?>
								<li class="text-center">
									<div class="home_category-image">
										<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" class="img text-center">
											<img  class="img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['image'], ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" />
										</a>
									</div>
									<h5 class="home_category-name" >
										<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['name'], ENT_QUOTES, 'UTF-8', true);?>

									</h5>
									<a class="home_category-btn" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
										<?php echo smartyTranslate(array('s'=>"Découvrir"),$_smarty_tpl);?>
				...
				<div class="lined-title">
					<h2><?php echo smartyTranslate(array('s'=>"Les"),$_smarty_tpl);?>
 <i>+</i> <?php echo smartyTranslate(array('s'=>"de"),$_smarty_tpl);?>
 sun<span>device</span></h2>
				</div>
				
				<div id="sundevice_plus_header"  class="sundevice_plus container">
...
../img/new-images/1-qualite-garantie.png" alt="<?php echo smartyTranslate(array('s'=>'Qualité garantie'),$_smarty_tpl);?>
" />
							</div>
							<h5><?php echo smartyTranslate(array('s'=>'Qualité garantie'),$_smarty_tpl);?>
</h5>
						</li>
						<li class="col-lg-3 text-center">
							<div class="sundevice_plus-image">
								<img  class="img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['css_dir']->value, ENT_QUOTES, 'UTF-8', true);?>
../img/new-images/2-meilleures-offres-du-marche.png" alt="<?php echo smartyTranslate(array('s'=>'Meilleures offres du marché'),$_smarty_tpl);?>
" />
							</div>
							<h5><?php echo smartyTranslate(array('s'=>'Meilleures offres'),$_smarty_tpl);?>
<br/><?php echo smartyTranslate(array('s'=>'du marché'),$_smarty_tpl);?>
</h5>
						</li>
						<li class="col-lg-3 text-center">
							<div class="sundevice_plus-image">
								<img  class="img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['css_dir']->value, ENT_QUOTES, 'UTF-8', true);?>
../img/new-images/livraison-rapide.png" alt="<?php echo smartyTranslate(array('s'=>'Livraison rapide'),$_smarty_tpl);?>
" />
							</div>
						...
						<li class="col-lg-3 text-center">
							<div class="sundevice_plus-image">
								<img  class="img-responsive" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['css_dir']->value, ENT_QUOTES, 'UTF-8', true);?>
../img/new-images/service-client.png" alt="<?php echo smartyTranslate(array('s'=>'Service client à l\'écoute & disponible'),$_smarty_tpl);?>
" />
							</div>
							<h5><?php echo smartyTranslate(array('s'=>"Service client à l'écoute & disponible"),$_smarty_tpl);?>
</h5>
						</li>
					</ul>
				</div>
